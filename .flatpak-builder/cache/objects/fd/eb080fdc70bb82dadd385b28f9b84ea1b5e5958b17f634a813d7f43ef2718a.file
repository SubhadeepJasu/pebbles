/* valadoc-0.48.vapi generated by valac, do not modify. */
...
namespace Valadoc {
	namespace Api {
		...
		public class Class : Valadoc.Api.TypeSymbol {
			...
			public bool is_sealed { get; private set; }
		...
		public class Field : Valadoc.Api.Symbol {
			...
			public bool is_class { get; private set; }
			public bool is_static { get; private set; }
		...
		[CCode (cheader_filename = "valadoc.h")]
		public class Parameter : Valadoc.Api.Symbol {
			public Parameter (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string? name, Vala.SymbolAccessibility accessibility, Vala.ParameterDirection type, bool ellipsis, Vala.Parameter data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public Valadoc.Content.Run default_value { get; set; }
		...
		public abstract class Visitor : GLib.Object {
			...
			public virtual void visit_formal_parameter (Valadoc.Api.Parameter item);
