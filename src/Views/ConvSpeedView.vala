...
namespace Pebbles {
    public class ConvSpeedView : Gtk.Grid {
        ...
        construct {
            ...
            from_entry.set_text (settings.load_last_session ? settings.conv_speed_from_entry : "0");
            ...
            to_entry.set_text (settings.load_last_session ? settings.conv_speed_to_entry : "0");
