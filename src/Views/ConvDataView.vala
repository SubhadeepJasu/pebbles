...
namespace Pebbles {
    public class ConvDataView : Gtk.Grid {
        ...
        construct {
            ...
            from_entry.set_text (settings.load_last_session ? settings.conv_data_from_entry : "0");
            ...
            to_entry.set_text (settings.load_last_session ? settings.conv_data_to_entry : "0");
        ...
        private void save_state () {
            settings.conv_data_from_entry = from_entry.get_text ();
            settings.conv_data_to_entry = to_entry.get_text ();
        }
