...
namespace Pebbles {
    public class CalculusDisplay : Gtk.Grid {
        ...
        void calc_make_display_ui () {
            ...
            answer_label = new Gtk.Label (settings.load_last_session ? settings.cal_output_text : "");
            ...
            input_entry.set_text (settings.load_last_session ? settings.cal_input_text : "0");
