...
namespace Pebbles {
    public class ConvPressView : Gtk.Grid {
        ...
        construct {
            ...
            from_entry.set_text (settings.load_last_session ? settings.conv_pressure_from_entry : "0");
            ...
            to_entry.set_text (settings.load_last_session ? settings.conv_pressure_from_entry : "0");
