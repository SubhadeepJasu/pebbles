...
namespace Pebbles {
    public class ProgrammerView : Gtk.Grid {
        ...
        public void prog_make_ui () {
            ...
            a_button.get_style_context ().add_class ("pebbles_button_font_size");
            d_button     = new StyledButton ("D");
            d_button.set_sensitive (false);
            d_button.get_style_context ().add_class ("pebbles_button_font_size");
            div_button   = new StyledButton ("\xC3\xB7");
            div_button.get_style_context ().add_class ("pebbles_button_font_size_h3");
            ...
            b_button.get_style_context ().add_class ("pebbles_button_font_size");
            b_button.set_sensitive (false);
            e_button     = new StyledButton ("E");
            e_button.get_style_context ().add_class ("pebbles_button_font_size");
            e_button.set_sensitive (false);
            multi_button = new StyledButton ("\xC3\x97");
            multi_button.get_style_context ().add_class ("pebbles_button_font_size_h3");
            ...
            c_button.get_style_context ().add_class ("pebbles_button_font_size");
            c_button.set_sensitive (false);
            f_button     = new StyledButton ("F");
            f_button.get_style_context ().add_class ("pebbles_button_font_size");
            f_button.set_sensitive (false);
            minus_button = new StyledButton ("\xE2\x88\x92");
            minus_button.get_style_context ().add_class ("pebbles_button_font_size_h3");
            ...
            lsh_rsh_button.get_style_context ().add_class ("pebbles_button_font_size");
            ...
            bit_mode_button.get_style_context ().add_class ("pebbles_button_font_size");
            ...
            or_button.get_style_context ().add_class ("pebbles_button_font_size");
            ...
            and_button.get_style_context ().add_class ("pebbles_button_font_size");
            ...
            xor_button.get_style_context ().add_class ("pebbles_button_font_size");
            ...
            not_button.get_style_context ().add_class ("pebbles_button_font_size");
            ...
            ans_button.get_style_context ().add_class ("pebbles_button_font_size");
            result_button = new StyledButton ("=", _("Result"), {"Return"});
            result_button.get_style_context ().add_class (Gtk.STYLE_CLASS_SUGGESTED_ACTION);
            result_button.get_style_context ().add_class ("pebbles_button_font_size_h3");
            shift_button = new StyledButton (_("Shift"), _("Access alternative functions"));
            shift_button.get_style_context ().add_class ("pebbles_button_font_size");
